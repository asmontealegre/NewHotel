...
class Usuario(models.Model):
    ...
    class Rol(models.TextChoices):
        RECEPCION='Recepción', _('Recepción')
        ADMINISTRACION='Administración', _('Administración')
        
    rol=models.CharField(max_length=25, choices=Rol.choices, default=Rol.RECEPCION, verbose_name="Rol")
